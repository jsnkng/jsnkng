  ...
  if (!loaded) {
    ...
    return (
      <Content>
        ...
        <Header 
          heroHeight={`90vh`} 
          heroBackground={`/gallery/Naftin/bg-1-af@2x.jpg`}
        >
          <div className='hero'>
            <Grid fluid={true}>
              <Row__Decorated>
                <Col__Decorated xs={12} sm={6} md={6} lgOffset={1} lg={6}>
                  <Logo>
                    <div className='top__logo'>
                     <a className='top__logo--text'>National<br />Park<br />Guides</a>
                      <img className='top__logo--image' src='/gallery/Naftin/logo-naftin-white@2x.png' alt='National Parks Guides' />
                    </div>
                  </Logo>
                  <div className='content'>
                    ...
                    <h4><a href="https://naftin.jsnkng.com" target="_blank" rel="noopener">Open National Park Guides</a></h4>

                  </div>
                   
                    </Col__Decorated>
                    <Col__Decorated xs={12} sm={6} md={6} lg={5}>
                    <Iframe url="https://naftin.jsnkng.com"
                      id="webFrame"
                      display="inherit"
                      position="relative"
                      ...
                      <div className='toggle__container'>
                        ...
                        <span className='toggle'><a href="https://naftin.jsnkng.com" target="_blank" rel="noopener">Open</a></span>
                      </div>
                    </Col__Decorated>
                  </Row__Decorated>
                </Grid>
