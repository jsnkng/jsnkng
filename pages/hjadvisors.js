  ...
  if (!loaded) {
    ...
    return (
      <>
        ...
        <Header backgroundURL={`/gallery/HJAdvisors/HJAdvisorsBackground.jpg`}
          parentLink={{ href: `/`, as: `/` }}>
          <Grid fluid={true}>
            <Row__Decorated>
              <Col__Decorated xs={12} sm={6} md={6} lgOffset={1} lg={6}>
                ...
                <div className='content'>
                  ...
                  <p>All businesses need to generate leads and develop brand awareness, Atkins Commercial Real Estate uses </p>
                </div>
                <a className='thumbnail' href="https://hjadvisors.com" target="_blank" rel="noopener">
                  <img src='/gallery/HJAdvisors/hjadvisors_thumbnail.jpg' />
                </a>
                <a className='link' href="https://hjadvisors.com" target="_blank" rel="noopener">
                  Launch Hugh Johnson Advisors
                </a>
              </Col__Decorated>
              <Col__Decorated xs={12} sm={6} md={6} lg={5}>
                <Iframe url="https://hjadvisors.com"
                  id="webFrame"
                  display="inherit"
                  position="relative"
                ...
                <div className='toggle__container'>
                  ...
                  <span><a href="https://hjadvisors.com" target="_blank" rel="noopener">Launch</a></span>
                </div>
              </Col__Decorated>
            </Row__Decorated>
          </Grid>
...
const Header = styled.header`
  ...
  #webFrame {
    ...
    background-image: url(/gallery/HJAdvisors/HJAdvisors_logo.png);
