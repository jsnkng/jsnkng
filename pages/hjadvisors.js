  ...
  if (!loaded) {
    ...
    return (
      <>
        ...
        <Hero backgroundURL={`/gallery/HJAdvisors/HJAdvisorsBackground.jpg`}
          vHeight={'90vh'}> 
          <BackgroundOverlay />
          <Grid>
          <Row__Decorated>
            <Col__Decorated xs={12} sm={6} md={6} lgOffset={1} lg={5}>
              <div className='description'>
                ...
                <div className='content'>
                  ...
                  in the media through his Hugh’s Market Minute video segment. The website provides a high-level overview
                  of the products and services Hugh Johnson Advisors offers and makes it easy for prospective clients
