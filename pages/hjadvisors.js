  ...
  if (!loaded) {
    ...
    return (
      <Content>
        ...
        <Header 
          heroHeight={`90vh`} 
          heroBackground={`/gallery/HJAdvisors/HJAdvisorsBackground.jpg`}
        >
          <div className='hero'>
            <Grid fluid={true}>
              <Row__Decorated>
                <Col__Decorated xs={12} sm={6} md={6} lgOffset={1} lg={6}>
                  <Logo>
                    <div className='top__logo'>
                      <img className='top__logo--image' src='/gallery/HJAdvisors/HJAdvisors_logo.png' alt='Hugh Johnson Adivsors' />
                    </div>
                  </Logo>
                  <div className='content'>
                    ...
                    <h4><a href="https://hjadvisors.com" target="_blank" rel="noopener">Launch Hugh Johnson Advisors</a></h4>
                    ...
                    <Iframe url="https://hjadvisors.com"
                      ...
                      <div className='toggle__container'>
                        ...
                        <span className='toggle'><a href="https://hjadvisors.com" target="_blank" rel="noopener">Open</a></span>
                      </div>
                    </Col__Decorated>
                  </Row__Decorated>
                </Grid>
