                ...
                <Col__Decorated xs={12} sm={6} md={6} lgOffset={1} lg={6}>
                  <Logo>
                    <div className='top__logo'>
                      <img className='top__logo--image' src='/gallery/AdCycle/logo-adcycle-white-rounded.png' alt='AdCycle' />
                    </div>
                  </Logo>
                  <div className='content'>
                    ...
                    <h4><a href="https://adcycle.co" target="_blank" rel="noopener">Launch AdCycle</a></h4>

                  </div>
                   
                    </Col__Decorated>
                    <Col__Decorated xs={12} sm={6} md={6} lg={5}>
                    <Iframe url="https://adcycle.co"
                      id="webFrame"
                      display="inherit"
                      position="relative"
                      ...
                      <div className='toggle__container'>
                        ...
                        <span className='toggle'><a href="https://adcycle.co" target="_blank" rel="noopener">Open</a></span>
                      </div>
                    </Col__Decorated>
                  </Row__Decorated>
                </Grid>
