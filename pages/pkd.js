  ...
  if (!loaded) {
    ...
    return (
      <Content>
        ...
        <Header 
          heroHeight={`90vh`} 
          heroBackground={`/gallery/PKD/PKDBackground.jpg`}
        >
          <div className='hero'>
            <Grid fluid={true}>
              <Row__Decorated>
                <Col__Decorated xs={12} sm={6} md={6} lgOffset={1} lg={6}>
                  <Logo>
                    <div className='top__logo'>
                     <a className='top__logo--text'>Uncover PKD</a>
                    </div>
                  </Logo>
                  <div className='content'>
                    <h3>HTML/Pug, CSS/SCSS/Bootstrap, JavaScript/JQuery, Gulp, Docker</h3>
                    <h3>Responsive Design</h3>
                    <h3>Custom Gulp/Docker Build</h3>
                    ...
                    <h4><a href="https://pkd.jsnkng.com/" target="_blank" rel="noopener">Open Uncover PKD</a></h4>

                  </div>
                   
                    </Col__Decorated>
                    <Col__Decorated xs={12} sm={6} md={6} lg={5}>
                    <Iframe url="https://pkd.jsnkng.com/"
                      id="webFrame"
                      display="inherit"
                      position="relative"
                      ...
                      <div className='toggle__container'>
                        ...
                        <span className='toggle'><a href="https://pkd.jsnkng.com/" target="_blank" rel="noopener">Open</a></span>
                      </div>
                    </Col__Decorated>
                  </Row__Decorated>
                </Grid>
