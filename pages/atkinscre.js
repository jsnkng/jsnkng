  ...
  if (!loaded) {
    ...
    return (
      <>
        ...
        <Header 
        backgroundURL={`/gallery/AtkinsCRE/AtkinsCRE_Background.jpg`}
          parentLink={{ href: `/`, as: `/` }}>
          <Grid fluid={true}>
            <Row__Decorated>
              <Col__Decorated xs={12} sm={6} md={6} lgOffset={1} lg={6}>
                ...
                <a className='thumbnail' href="https://atkinscre.com" target="_blank" rel="noopener">
                    <img src='/gallery/National_Park_Guides/natparguides__thumbnail_2.jpg' />
                  </a>
                <a className='link' href="https://atkinscre.com" target="_blank" rel="noopener">
                    Launch Atkins CRE
                </a>
              </Col__Decorated>
              <Col__Decorated xs={12} sm={6} md={6} lg={5}>
                ...
                <div className='toggle__container'>
                  ...
                  <span><a href="https://atkinscre.com" target="_blank" rel="noopener">Launch</a></span>
                </div>
              </Col__Decorated>
            </Row__Decorated>
          </Grid>
